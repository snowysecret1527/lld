...
// import logo from "C:/Users/komal/Desktop/liveloud/src/logo.svg";
...
//       <>
//         <nav >
//             <ul id='navbar1' className={this.state.clicked ? "#navbar1 active": "#navbar1"}>
//               <li>
...
export default function Nav() {
  ...
  // document.querySelector("#close-navbar").
  function onclickN() {
    let navbar = document.querySelector(".header .navbar");
  ...
  return (
    <header class="header">
      <div class="left-side">
        ...
        <nav class="navbar" onClick={onclickN}>
      ...
      <div class="icons">
        <div id="menu-btn" onClick={onclickM} class="fas fa-bars"></div>
      </div>
    </header>
  );
}